...
pub fn get_supported_currencies() -> Vec<CurrencyInfo> {
    vec![
        ...
        CurrencyInfo {
            ...
            symbol: "€".to_string(),
            pyth_id: Some(
                "a995d00bb36a63cef7fd2c287dc105fc8f3d93779f062f09551b0af3e81ec30b".to_string(),
            ),
        },
        CurrencyInfo {
            code: "GBP".to_string(),
            ...
            symbol: "£".to_string(),
            pyth_id: Some(
                "84c2dde9633d93d1bcad84e7dc41c9d56578b7ec52fabedc1f335d673df0a7c1".to_string(),
            ),
        },
        CurrencyInfo {
            code: "CAD".to_string(),
            ...
            symbol: "C$".to_string(),
            pyth_id: Some(
                "3112b03a41c910ed446852aacf67118cb1bec67b2cd0b9a214c58cc0eaa2ecca".to_string(),
            ),
        },
        CurrencyInfo {
            code: "AUD".to_string(),
            ...
            symbol: "A$".to_string(),
            pyth_id: Some(
                "67a6f93030420c1c9e3fe37c1ab6b77966af82f995944a9fefce357a22854a80".to_string(),
            ),
        },
        CurrencyInfo {
            code: "JPY".to_string(),
            ...
            symbol: "¥".to_string(),
            pyth_id: Some(
                "ef2c98c804ba503c6a707e38be4dfbb16683775f195b091252bf24693042fd52".to_string(),
            ),
        },
        CurrencyInfo {
            code: "CHF".to_string(),
            ...
            pyth_id: Some(
                "0b1e3297e69f162877b577b0d6a47a0d63b2392bc8499e6540da4187a63e28f8".to_string(),
            ),
        },
        CurrencyInfo {
            code: "CNH".to_string(),
            ...
            symbol: "¥".to_string(),
            pyth_id: Some(
                "eef52e09c878ad41f6a81803e3640fe04dceea727de894edd4ea117e2e332e66".to_string(),
            ),
        },
        CurrencyInfo {
            code: "BRL".to_string(),
            ...
            symbol: "R$".to_string(),
            pyth_id: Some(
                "d2db4dbf1aea74e0f666b0e8f73b9580d407f5e5cf931940b06dc633d7a95906".to_string(),
            ),
        },
        CurrencyInfo {
            code: "MXN".to_string(),
            ...
            symbol: "MX$".to_string(),
            pyth_id: Some(
                "e13b1c1ffb32f34e1be9545583f01ef385fde7f42ee66049d30570dc866b77ca".to_string(),
            ),
        },
    ]
}
...
pub async fn fetch_exchange_rates() -> Result<HashMap<String, f64>, Box<dyn Error>> {
    ...
    for item in fx_response.parsed {
        ...
        if let Some(currency) = currencies
            .iter()
            .find(|c| c.pyth_id.as_ref().map_or(false, |id| *id == item.id))
        {
