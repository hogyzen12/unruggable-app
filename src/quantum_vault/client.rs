use crate::quantum_vault::types::{SplitResult, VaultInfo};
...
use solana_instruction as instruction_interface;
...
fn convert_compute_budget_instruction(interface_ix: instruction_interface::Instruction) -> Instruction {
    Instruction {
...
impl QuantumVaultClient {
    ...
    pub async fn split_vault(
        ...
        let compute_budget = convert_compute_budget_instruction(
